...
public class MainActivity extends AppCompatActivity {
    ...
    android.widget.Button msentotp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msentotp=findViewById(R.id.sendotpbutton);
        mgetphonenumber=findViewById(R.id.getphonenumber);
        mprogressbarofmain=findViewById(R.id.progessbarofmain);
        ...
        msentotp.setOnClickListener(new View.OnClickListener() {
            @Override
